...
public class CacheValidationBehavior<TRequest, TResponse>(ICacheManager cacheManager, ILogger<CacheValidationBehavior<TRequest, TResponse>> logger) : CommandPipelineBehavior<TRequest, TResponse>
